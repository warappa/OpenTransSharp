...
namespace OpenTransSharp
{
    ...
    /// <br/>
    /// Example:<br/>
    /// In the case of a payment advice the roles do not specify if the payer sends the document to explain a remittance or the remittee sends the document to explain a direct debit.
    /// </summary>
