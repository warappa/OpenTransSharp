...
public class Quotation : IOpenTransRoot
{
    ...
    public Quotation(OpenTransVersion version, QuotationHeader header, IEnumerable<QuotationItem> items, QuotationSummary summary)
    {
        if (items is null)
        {
